...
function Home() {
  ...
  return (
    <main>
      ...
      <section
        ref={aiRef}
        className={`ai-section animate-section ${aiVisible ? "visible" : ""}`}
      >
        <Title
          ...
          title={
            <>
              <h1>
                <h1 className="highlight">Assistente AI</h1> Personalizzato
              </h1>
            </>
          }
          description={
            <>
              <p>
                Gestisci la tua casella di posta senza sforzo grazie a un'AI
                altamente adattabile che semplifica la comunicazione e aumenta
                la produttività.
              </p>
              ...
              <div className="list">
                <div className="benefit">
                  ...
                  <p>
                    <strong>Gestione intelligente delle email.</strong>{" "}
                    Organizza automaticamente i messaggi, dà priorità a ciò che
                    conta e mantiene la tua inbox sotto controllo.
                  </p>
                </div>
                ...
                <div className="benefit">
                  ...
                  <p>
                    <strong>Risposte automatiche.</strong> Gestisce le risposte
                    di routine così puoi concentrarti sul lavoro di maggior
                    valore.
                  </p>
                </div>
                ...
                <div className="benefit">
                  ...
                  <p>
                    <strong>Analisi della comunicazione.</strong> Analizza e
                    struttura i dati comunicativi per decisioni più chiare.
                  </p>
                </div>
                ...
                <div className="benefit">
                  ...
                  <p>
                    <strong>Supporto umano.</strong> Ricevi assistenza guidata
                    per personalizzare lo strumento e adattarlo al tuo flusso di
                    lavoro.
                  </p>
                </div>
              </div>
      ...
      <section
        ref={ctaRef}
        className={`cta-section animate-section ${ctaVisible ? "visible" : ""}`}
      >
        <div className="cta">
          <Title
            label="Cosa aspetti?"
            title={
              <>
                <h1>
                  Migliora la tua <h1 className="highlight">Produttività</h1>
                </h1>
              </>
            }
